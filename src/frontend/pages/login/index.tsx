      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          <div className="flex items-center gap-3 text-green-wildfire-500">
            <Network size={40} className="drop-shadow-[0_0_16px_#00ff00]" />
          </div>
          <h1 className="text-3xl font-bold tracking-widest text-green-wildfire-400 drop-shadow-[0_0_20px_rgba(0,255,0,0.6)] uppercase">
            Packet Tracer
          </h1>
          <p className="text-green-wildfire-300/50 text-xs tracking-widest uppercase">
            Secure Access Terminal
          </p>
        </div>

        {/* Card */}
        <div className="border-2 border-green-wildfire-700 bg-stealth-black-500 shadow-[0_0_30px_rgba(0,255,0,0.15)] p-8">
          <h2 className="text-green-wildfire-500 text-lg tracking-widest uppercase mb-6 text-center">
            Login
          </h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="
                    ...
                    text-green-wildfire-300 placeholder-stealth-black-50
                    text-sm tracking-wider
                    focus:outline-none focus:border-green-wildfire-500
                    focus:shadow-[0_0_10px_rgba(0,255,0,0.25)]
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative flex items-center">
                <Lock size={14} className="absolute left-3 text-green-wildfire-700 pointer-events-none" />
                <input
                  type="password"
                  value={password}
              ...
              <div className={`
                ...
                ${status === 'success'
                  ...
                  : status === 'error'
                    ...
                    : 'border-green-wildfire-800 text-green-wildfire-600 bg-stealth-black-600'}
              `}>
                ...
                <span>{status === 'loading' ? 'Authenticating...' : message}</span>
              </div>
            )}
            ...
            <button
              ...
              disabled={isLoading}
              className="
                mt-1 w-full py-3 border-2 border-green-wildfire-500
          ...
          <p className="mt-6 text-center text-xs tracking-wider text-stealth-black-50">
            ...
            <a
              href="/register/"
              className="
                text-red-red-500 hover:text-red-red-300
                hover:drop-shadow-[0_0_6px_rgba(255,0,0,0.6)]
        ...
        <p className="mt-4 text-center text-xs tracking-wider">
          <a
            href="/"
            className="
              text-green-wildfire-800 hover:text-green-wildfire-600
              transition-all duration-200 uppercase tracking-widest
            "
          >
            ← Back
